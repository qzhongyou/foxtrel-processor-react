 ...
 * @param option
 */
module.exports.insertCommonStaticPlugin = function (option) {
...
module.exports.insertCommonStaticPlugin.prototype.apply = function (compiler) {
    ...
    compiler.plugin('compilation', function (compilation) {
        compilation.plugin('html-webpack-plugin-before-html-processing', function (htmlPluginData, callback) {
            ...
            htmlPluginData.html = Html.replace(/(\<head\>)/, '$1<script src="' + self.publicPath + 'common/vendor' + foxtrel.config.get('vendorVersion')+ '.js"></script>');
            callback();
        })
    })
}
